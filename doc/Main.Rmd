...
```{r, fig.height=40, fig.align="center"}
...
What would be interesting now is to try to understand what concerned presidents. To do that, we will use topic modelling. 

## Step 12 - Topic Modeling
...
ldaOut.1 <-LDA(dtm.subset, k, method="Gibbs", control=list(nstart=nstart, 
                                                 seed = seed, best=best,
...
# # subset dtm - 1st term speeches
# list <- paste0("inaug",president.list,"-1.txt")
# dtm.1 <- dtm[list,]
# 
# # subset dtm - 1st term speeches
# list <- paste0("inaug",president.list,"-2.txt")
# dtm.2 <- dtm[list,]
# 
# # set parameters for Gibbs sampling
# burnin <- 4000
...
# 
# # run LDA using Gibbs sampling
# ldaOut.1 <-LDA(dtm.1, k, method="Gibbs", control=list(nstart=nstart, 
#                                                  seed = seed, best=best,
#                                                  burnin = burnin, iter = iter, 
#                                                  thin=thin))
# 
# ldaOut.2 <-LDA(dtm.2, k, method="Gibbs", control=list(nstart=nstart, 
#                                                  seed = seed, best=best,
#                                                  burnin = burnin, iter = iter, 
#                                                  thin=thin))
